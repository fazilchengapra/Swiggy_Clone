...
const NavBar = () => {
  const cartCount = useSelector(
    (store) => store.cart.items.data.cartItemsCount
  );
  const [isHover, setIsHover] = useState(false);

  return (
    <div className="block">
      <nav className="bg-white fixed  grid-rows-1 w-full z-20 top-0 start-0 flex-wrap shadow-sm">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <a
            href="https://flowbite.com/"
            className="flex items-center space-x-3 rtl:space-x-reverse"
          >
            <img src={swiggy} className="h-14" alt="Flowbite Logo" />
          </a>

          <div
            className="address text-gray-900 flex cursor-pointer "
            role="button"
          >
            <span className="text-gray-800 font-bold px-2 underline decoration-1.8 underline-offset-8 cursor-pointer hover:text-primary uppercase">
              Home
            </span>
            <span className="text-sm text-slate-500 capitalize">
              {truncate("W7J8+FWV, Valummel, Kochi, Kerala 682005, India", 30)}
            </span>
          </div>
          ...
          <div
            ...
            id="navbar-sticky"
          >
            <ul className="flex flex-col p-4 md:p-0 mt-4 borderrtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
              <li>
                <div className=" flex items-center ">
                  <a
                    ...
                    aria-label="Services"
                  >
                    <span className="flex text-base font-semibold text-gray-600 cursor-pointer hover:text-primary">
                      <svg class="h-6 w-6 mx-3" viewBox="0 0 20 20" fill="none">
                        <rect
                          x="2.46094"
                          y="7.98145"
                          width="15.0784"
              ...
              <li>
                <div className=" flex items-center text-base px-3">
                  <a href="#" className=" py-2  flex " aria-label="Services">
                    <span className="flex font-semibold text-gray-600 cursor-pointer hover:text-primary">
                      <svg
                        class="h-6 w-6 mx-3"
                        viewBox="0 0 32 32"
                        fill="#686b78"
                  ...
                  <span className="text-xxs font-bold text-primary mb-5 mx-0">
                    NEW
                  </span>
                </div>
              </li>
              ...
              <li>
                <div className=" flex items-center text-base ">
                  <a className="py-2 flex px-3 r" aria-label="Services">
                    <Link to={"/cart"}>
                      <span
                        className="flex items-center font-semibold text-gray-600 cursor-pointer hover:text-primary cursor-pointe"
                        onMouseEnter={() => setIsHover(true)}
                        onMouseLeave={() => setIsHover(false)}
                      >
                        <div>
                          <svg
                            className="h-6 w-6 mx-3 cursor-pointer text-white"
                            viewBox="-1 0 37 32"
                            fill={
                              cartCount
                                ? `${isHover ? "#fc8019" : "#22c55e"}`
                                : "none"
                            }
                            stroke={
                              cartCount
